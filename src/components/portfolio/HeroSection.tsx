...
import HeroScene from "@/components/three/Hero/HeroScene";
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 3xl:gap-16 4xl:gap-20 items-center">
            ...
            <Reveal delay={0.15}>
              <div className="max-w-2xl mx-auto md:mx-0">
                <p className="text-lg leading-relaxed text-foreground/80">
                  I'm a Computer Science student driven by curiosity 
                  and a passion for creating meaningful technology.
                  My interests lie in Artificial Intelligence, 
                  Machine Learning, and software engineering, where 
                  I enjoy transforming ideas into practical 
                  solutions. Every project I build represents 
                  another step in my journey of continuous 
          ...
          <Reveal delay={0.25}>
            <div className="flex justify-center items-center">
              <div className="w-full h-[520px] max-w-[520px] mx-auto">
                  <HeroScene />
              </div>
            </div>
          </Reveal>
